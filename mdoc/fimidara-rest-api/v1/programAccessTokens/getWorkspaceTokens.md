...
## `/v1/agentTokens/getWorkspaceTokens` — `post`
...
`GetWorkspaceAgentTokensEndpointSuccessResult`
| Field | Type | Description |
| - | - | - |
|`tokens`|`array` of `object`|See below for `AgentToken`'s object fields. undefined|

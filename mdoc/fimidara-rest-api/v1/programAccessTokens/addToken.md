...
|`token`|`object`|Not required|See below for `NewAgentTokenInput`'s object fields. |
...
| Field | Type | Description |
| - | - | - |
|`token`|`object`|See below for `AgentToken`'s object fields. |

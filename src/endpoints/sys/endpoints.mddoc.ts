...
import {SysDeleteFileEndpointParams} from './deleteFile/types.js';
import {
...
const deleteFileParams = mddocConstruct
  .constructFieldObject<SysDeleteFileEndpointParams>()
...
const readFileParams = mddocConstruct
  .constructFieldObject<SysReadFileEndpointParams>()

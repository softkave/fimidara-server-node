...
import resolvePermissionsEndpoint from './handler.js';
import {
...
describe('resolvePermissions', () => {
  test('correct results returned', async () => {
    ...
    // Test
    const reqData =
      RequestData.fromExpressRequest<ResolvePermissionsEndpointParams>(
    ...
    const result = await resolvePermissionsEndpoint(reqData);

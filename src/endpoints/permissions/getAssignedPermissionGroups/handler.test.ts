...
import getAssignedPermissionGroupsEndpoint from './handler.js';
...
describe('getAssignedPermissionGroups', () => {
  test('implicit access and do not include inherited permission groups', async () => {
    ...
    const result01 = await getAssignedPermissionGroupsEndpoint(
  ...
  test('include inherited permission groups', async () => {
    ...
    const result02 = await getAssignedPermissionGroupsEndpoint(
      RequestData.fromExpressRequest(agentToken01Req, {
        entityId: agentToken01.resourceId,
  ...
  test('with read permission', async () => {
    ...
    const result03 = await getAssignedPermissionGroupsEndpoint(

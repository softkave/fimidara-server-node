...
import {fetchEntityAssignedPermissionGroupList} from '../getAssignedPermissionGroups/utils.js';
import {assignPgListToIdList, toAssignedPgListInput} from '../testUtils.js';
import unassignPermissionGroupsEndpoint from './handler.js';
...
describe('unassignPermissionGroups', () => {
  test('permission groups unassigned', async () => {
    ...
    const result01 = await unassignPermissionGroupsEndpoint(

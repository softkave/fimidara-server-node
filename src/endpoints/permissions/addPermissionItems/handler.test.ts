...
import addPermissionItemsEndpoint from './handler.js';
...
describe('addItems', () => {
  ...
  test('permission items are not duplicated', async () => {
    ...
    // First insert
    await addPermissionItemsEndpoint(reqData);
  ...
  test('permission items folded into wildcard', async () => {
    ...
    let result = await addPermissionItemsEndpoint(reqData);
    assertEndpointResultOk(result);
    ...
    // Trying again
    result = await addPermissionItemsEndpoint(reqData);
    assertEndpointResultOk(result);
